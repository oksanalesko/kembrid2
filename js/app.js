            ...
            if (document.querySelector(".hero__slider")) new core(".hero__slider", {
                ...
                pagination: {
                    ...
                    renderBullet: function(index, className) {
                        ...
                        let slideNumberFormatted = ("0" + slideNumber).slice(-2);
                        let totalSlidesFormatted = ("0" + totalSlides).slice(-2);
                        let span = document.createElement("span");
                        span.classList.add(className);
                        span.dataset.slideNumber = slideNumberFormatted;
                        span.dataset.totalSlides = totalSlidesFormatted;
...
***************************************************************************** */
        ...
        function addHeaderBackClassOnScroll() {
            if (window.scrollY > 90) header.classList.add("header-back"); else header.classList.remove("header-back");
        }
        window.addEventListener("scroll", addHeaderBackClassOnScroll);
        window["FLS"] = true;
        isWebp();
        menuInit();
        spollers();
